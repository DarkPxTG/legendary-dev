    ...
    return (
        <div className={`home-tab-con transition-all duration-300`}>
            ...
            <div className="space-y-3 px-4 mt-8 mb-8">
                <button className="shine-effect w-full bg-[#ffffff0d] border-[1px] border-[#797979] rounded-lg px-4 py-2 flex items-center justify-between">
                ...
                <button className="w-full bg-[#000000] border-[1px] border-[#797979] rounded-lg px-4 py-2 flex items-center justify-between">
                    <div className="flex items-center gap-3 font-medium">
